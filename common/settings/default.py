class DefaultConfig(object):
    ...
    QINIU_ACCESS_KEY = 'vVkttHh3FawBqPrK-Mgy7BczaPYMxA9tgHIwPZvQ'
    QINIU_SECRET_KEY = 'lCCV_p5BJBR3XkVVrYY6i2N-ceH6GFQDQOJ-iWfm'
    QINIU_BUCKET_NAME = 'test'
    QINIU_DOMAIN = 'http://ptc3ol8b9.bkt.clouddn.com/'
